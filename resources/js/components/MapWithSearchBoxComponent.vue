<template>
    <div class="container">
        ...
        <div class="container-fluid">
            ...
            <div class="container">
                <div class="container-fluid">
                    <GMapMap :center="mapCenter" :zoom="7" ref="myMapRef" :options="mapOptions" @click="handleMapClick"
                        style="height: 400px;">
                        <GMapMarker v-for="(marker, index) in markers" :key="index" :position="marker.position"
                            :title="marker.title" :clickable="true" :draggable="true" @click="openMarker(marker.id)"
                            @closeclick="openMarker(null)">
                            <GMapInfoWindow :position="marker.position" :closeclick="true" @closeclick="openMarker(null)"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-input">
                                        <label for="For the Job Location">Search through the job location</label>
                                        <div class="input-group">
                                            <AutoComplete class="form-control" placeholder="Search the Job Location here"
...
export default {
    ...
    setup(props,context) {
        ...
        const mapCenter = ref({ lat: 51.5000, lng: 0.1167 });
