            ...
            <div class="row">
              ...
              <div class="col-md-3 ml-auto">
                <div class="text-center">
                  <img src="/public/assets/frontend/default/img/icons/Mastercard.png" style="width:50px" />
                ...
                <div class="row">
                  <div class="col-8">
                    <p class="mb-0">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque
                      nihil neque
                      quisquam aut repellendus, dicta vero? Animi dicta cupiditate, facilis provident quibusdam ab
                      quis,
                ...
                <div class="row">
                  <div class="col-lg-5 mb-lg-0 mb-3">
                    <p class="mb-0">Providing your payment details helps us verify your identity and
                      simplifies the process of paying future invoices. Payments will be processed
                      from your card automatically to settle any outstanding invoices.
                  ...
                  <div class="col-lg-7">
                    <form id="payment-form" class="form" ref="form">
                      <div class="row">
                        <div class="col-12">
                          <div class="form__div">
                            <input id="card-holder-email" v-model="cardHolderEmail" type="email" class="form-control"
                              placeholder=" ">
                            <label for="card-holder-email" class="form__label">Card Holder Email</label>
                          </div>
                          <span class="error my-2 text-danger">{{ errors.cardHolderEmail }}</span>
                        </div>
                        <div class="col-12">
                          <div class="form__div">
                          ...
                          <span class="error my-2 text-danger">{{ errors.cardNumber }}</span>
                        </div>
                        <div class="col-6">
                          <div class="form__div">
                            <input id="card-expiry" v-model="cardExpiry" v-mask="'##/##'" type="tel" class="form-control"
                              placeholder=" ">
                            <label for="card-expiry" class="form__label">MM / YY</label>
                          </div>
                          <span class="error my-2 text-danger">{{ errors.cardExpiry }}</span>
                        </div>
                        <div class="col-6">
                          <div class="form__div">
                            <input id="card-cvc" v-model="cardCvc" type="text" v-mask="'###'" class="form-control"
                              placeholder=" ">
                            <label for="card-cvc" class="form__label">CVV Code</label>
                          </div>
                          <span class="error my-2 text-danger">{{ errors.cardCvc }}</span>

                        </div>
                        <div class="col-12">
                          <div class="form__div">
                            <input id="card-holder-name" v-model="cardHolderName" type="text" class="form-control"
                              placeholder=" ">
                            <label for="card-holder-name" class="form__label">Name on the Card</label>
                          </div>
                          <span class="error my-2 text-danger">{{ errors.cardHolderName }}</span>

                        </div>
                        <div class="col-12">
                          <div class="form__div">
                            <input id="card-holder-address" v-model="cardHolderAddress" type="text" class="form-control"
                              placeholder=" ">
                            <label for="card-holder-address" class="form__label">Address</label>
                          </div>
                          <span class="error my-2 text-danger">{{ errors.cardHolderAddress }}</span>

                        </div>
                        <div class="col-12">
                          <div class="btn btn-primary" id="submit-button" @click="submitCard">Submit</div>
                        </div>
                      </div>
                    </form>
                  </div>
  ...
  methods: {
    async submitCard() {
      ...
      if (!this.cardHolderEmail) {
        this.errors.cardHolderEmail = 'Please enter your Card Holder Email Address';
      } else if (!this.isValidEmail(this.cardHolderEmail)) {
        this.errors.cardHolderEmail = 'Please enter a valid email address';
      } else {
      ...
      if (!this.cardNumber) {
        ...
        this.errors.cardNumber = 'Card Number must be at least 16 characters long';
      }
       else {
      ...
      if (!this.cardHolderAddress) {
        this.errors.cardHolderAddress = 'Please enter the cardholder address';
      } else if (this.cardHolderAddress.length < 10) {
        this.errors.cardHolderAddress = 'Address must be at least 10 characters long';
      } else {
      ...
      try {
        ...
        if (error.response.status === 422) {
          ...
          // Handle other errors
          Swal.fire('Error!', 'An unexpected error occurred while processing your request. Please try again later.', 'error');
