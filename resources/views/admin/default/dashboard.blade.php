...
<div class="card card_shadow">
    ...
    <div class="card-body">
        <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="4" data-xl-items="3" data-md-items="2" data-sm-items="1" data-arrows='true'>
            @foreach (\App\Models\Project::has('project_user')->has('projectBids')->latest()->limit(10)->get() as $key => $project)
                <div class="caorusel-box">
                    <a class="card text-inherit" href="{{ route('project.details', $project->slug) }}" target="_blank">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-3">
                                
                                <div class="text-left flex-shrink-0 pl-3">
                                    <span class="small">Job Name</span>
                                    
                                </div>
                                
                            </div>
                            <div class="d-flex justify-content-between mb-3">
                            <h5 class="fs-14 fw-600 lh-1-5 text-primary">
                                {{ ($project->name) }}
                            </h5>
                            </div>
                            <h5 class="fs-14 fw-600 lh-1-5 text-secondary">
                                {{ $project->excerpt }}
                            </h5>
                        </div>
                    </a>
