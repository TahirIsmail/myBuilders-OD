                                        ...
                                        <div class="lead-details__actions-layout">
                                            <div class="col-md-7 custom_padding" style="display: grid !important">
                                                <a href="#" class="lead-details__meta">
                                                    ...
                                                    <span class="lead-details__meta-title">Manchester</span>
                                                    <span class="lead-details__meta-detail">6.9 miles away</span></a>

                                                    <a href="#" class="lead-details__meta">
                                                        <i class="fas fa-phone-alt mb-phone no-space lead-details__meta-icon"></i>

    
                                                        <span class="lead-details__meta-title">Niall</span>
                                                        <span class="lead-details__meta-detail" style="color: #007bff !important">07568 584 705</span></a>
