            ...
            <div class="d-flex align-items-start">
                ...
                <div class="aiz-user-panel">
                    ...
                    @if ($verification == null || !$verification->verified)
                        <div class="alert alert-danger mb-3">
                            {{ translate('Please verify your identity by sending verification request to Admin in your profile After Verification You will be able to respond to incoming leads') }}.
                            <a href="{{ route('user.profile') }}" class="alert-link">{{ translate('Verify Now') }}</a>
                        </div>
                    @endif
				...
				@endif --}}
                    <div class="row gutters-15">
                        <div class="col-md-4 ">
                            <div
                                class="bg-primary card_shadow text-white mb-4 overflow-hidden rounded-2 d-flex flex-column justify-content-between">
                                <div class="px-4 pt-4">
                        ...
                        <div class="col-md-4 d-flex flex-column justify-content-between">
                                        ...
                                        <div class="col-5 d-flex justify-content-end align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36"
                                                ...
                                                <g id="Group_22129" data-name="Group 22129"
                                                    transform="translate(-4 -3.053)">
                                                    <path id="Path_25837" data-name="Path 25837"
                                                        d="M10,5.054V35.021h6.545V5.054Z"
                                                        transform="translate(13.636 4.029)" fill="#45b5aa"
                                                        fill-rule="evenodd" />
                                                    <path id="Path_25838" data-name="Path 25838"
                                                        d="M7,8.027V29.039h6.545V8.027Z" transform="translate(6.818 10.014)"
                                                        fill="#45b5aa" fill-rule="evenodd" />
                                                    <path id="Path_25839" data-name="Path 25839"
                                                        d="M4,11.054V22.942h6.545V11.054Z" transform="translate(0 16.108)"
                                                        fill="#45b5aa" fill-rule="evenodd" />
                                                    <path id="Path_25840" data-name="Path 25840" d="M13,3.053h6.545v36H13Z"
                                                        transform="translate(20.455 0)" fill="#45b5aa"
                                                        fill-rule="evenodd" />
                                                </g>
                                            </svg>
                                        </div>
                            ...
                            <div class="card_shadow bg-transparent mb-4 overflow-hidden rounded-2"
                                style="border: 2px solid #e2583e; min-height:130px;">
                                <div class="px-4 pt-4">
                                    <div class="row">
                                        <div class="col-7">
                                        ...
                                        <div class="col-5 d-flex justify-content-end align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36"
                                                ...
                                                <g id="Group_22130" data-name="Group 22130"
                                                    transform="translate(-1184 -673)">
                                                    <g id="Group_22128" data-name="Group 22128"
                                                        transform="translate(1184 685)">
                                                        <path id="Path_25837" data-name="Path 25837"
                                                            d="M10,5.054V23.972h6.545V5.054Z"
                                                            transform="translate(9.636 0.026)" fill="#e2583e"
                                                            fill-rule="evenodd" />
                                                        <path id="Path_25838" data-name="Path 25838"
                                                            d="M7,8.027v11.2h6.545V8.027Z" transform="translate(2.818 4.77)"
                                                            fill="#f17f53" fill-rule="evenodd" />
                                                        <path id="Path_25839" data-name="Path 25839"
                                                            d="M4,11.054V24.892h6.545V11.054Z"
                                                            transform="translate(-4 -0.895)" fill="#f8b84e"
                                                            fill-rule="evenodd" />
                                                        <path id="Path_25840" data-name="Path 25840"
                                                            d="M13,3.053h6.545v24H13Z" transform="translate(16.455 -3.053)"
                                                            fill="#f8b84e" fill-rule="evenodd" />
                                                    </g>
                                                    <path id="Path_25841" data-name="Path 25841"
                                                        d="M33.723,3.5a.948.948,0,1,0,.04,1.895h1.514l-9.493,9.474H20.5a.947.947,0,0,0-.815.455l-5.059,8.432-2.937-2.918a.891.891,0,0,0-.663-.284H3.447a.947.947,0,0,0,0,1.895h7.181l3.524,3.505a.891.891,0,0,0,.663.284h.114a.985.985,0,0,0,.7-.455l5.4-9.019h5.154a.891.891,0,0,0,.663-.284l9.758-9.758V8.237a.947.947,0,0,0,1.895,0V4.447a.947.947,0,0,0-.947-.947H33.723Z"
                                                        transform="translate(1181.5 669.5)" fill="#303744" />
                                                </g>
                                            </svg>
                                        </div>
                                    </div>
                    ...
                    <div class="">
                        <div
                            class="card card_shadow card_border p-4 rounded-2 bg-hov-soft-primary border-1 border-gray-light">
                            <div class="row gutters-15">
                                <div class="col-md-4">
                                    <div class="rounded-1 p-4 mb-4 d-flex flex-column justify-content-center"
                                        style="min-height: 116px;background: #bf1932;">
                                        <div class="text-white">{{ translate('This Month Expense') }}</div>
                                        <div class="h4 fw-700 text-white">
                                            {{ single_price(\App\Models\MilestonePayment::where('paid_status', 1)->where('freelancer_user_id', Auth::user()->id)->whereBetween('updated_at', [Carbon::now()->startOfMonth(), Carbon::now()->endOfMonth()])->sum('amount')) }}
                                        </div>
                                    </div>
                                    <div class="rounded-1 p-4 bg-dark d-flex flex-column justify-content-center"
                                        style="min-height: 116px;background: #45b5aa;">
                                        <div class="text-white">{{ translate('Total Expense') }}</div>
                                        <div class="h4 fw-700 text-white">
                                            {{ single_price(\App\Models\MilestonePayment::where('paid_status', 1)->where('freelancer_user_id', Auth::user()->id)->sum('amount')) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                    ...
                    <div class="row gutters-15">
                        <div class="col-md-4 mb-4">
                            <a href="{{ route('service.freelancer_index') }}"
                                class="btn btn-block btn-primary rounded-1 py-4">{{ translate('My Services') }}</a>
                        </div>
                        <div class="col-md-4 mb-4">
                            <a href="{{ route('user.profile') }}"
                                class="btn btn-block btn-primary rounded-1 py-4">{{ translate('Profile Settings') }}</a>
                        </div>
                        <div class="col-md-4 mb-4">
                            <a href="{{ route('recieved_shortlist_payment_index') }}"
                                class="btn btn-block btn-primary rounded-1 py-4">{{ translate('Shortlist Payments Requests') }}</a>
                        </div>
                    </div>
                    <div class="row gutters-15">
                        <div class="col-md-6">
                                ...
                                <div class=" card-body px-0 pt-0">
                                    <div class="aiz-auto-scroll c-scrollbar-light px-4"
                                        ...
                                        <ul class="list-group list-group-flush">
                                            @foreach ($user_projects as $key => $projectUser)
                                                @if ($projectUser != null && !$projectUser->closed)
                                                    <li class="list-group-item border-0 px-0">
                                                        <a href="{{ route('project.details', $projectUser->slug) }}"
                                                            class="text-inherit d-flex align-items-center">
                                                            <span
                                                                class="avatar avatar-sm flex-shrink-0 bg-soft-primary mr-3">
                                                                @if ($projectUser->client->photo != null)
                                                                    <img
                                                                        src="{{ custom_asset($projectUser->client->photo) }}">
                                                                @else
                                                                    <img
                                                                        src="{{ my_asset('assets/frontend/default/img/avatar-place.png') }}">
                                                                @endif
                                                            </span>
															<div class="text-inherit d-flex align-items-center">
                                                        ...
                                                        <div class="container">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="text-inherit align-items-center">
                                                                        <span style="border-radius: 14px !important;
                                                                        font-size: 8px !important;
                                                                        text-align: center !important;
                                                                        padding: 7px 7px !important;"  class="ml-2 flex-grow-1 alert-{{ $projectUser->status === 'paid' ? 'success' : 'danger' }} text-truncate-2">SHORTLISTING FEES {{ \Illuminate\Support\Str::upper($projectUser->status) }}</span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
    ...
    <script type="text/javascript">
        AIZ.plugins.chart('#pie-1', {
            ...
            data: {
                ...
                datasets: [{
                    data: [{{ Auth::user()->bids->count() }}, {{ $completedProjects }},
                        {{ $onGoingProjects }}
                    ],
                    backgroundColor: [
                        "#f8b84e",
