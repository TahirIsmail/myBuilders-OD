				...
				@endif --}}
                    ...
                    <div class="row gutters-15">
                        <div class="col-md-4 d-flex">
                            <div
                                class="card card_shadow card_border w-100 rounded-2 bg-hov-soft-primary border-1 border-gray-light">
                                <div class="card-body mt-3">
                                    <a href="{{ route('post_project') }}"
                                        class="btn btn-primary btn-block rounded-1 py-3 mb-3">
                                    ...
                                    <div class="mb-1">
                                        <small
                                            class="fs-12 text-secondary">{{ translate('Meet your need from our') }}</small>
                                    </div>
                                    <a href="{{ route('services.category', '') }}"
                                        class="text-primary fs-14 fw-700 d-flex align-items-center mb-3">
                                        <i class="la la-search fs-20 fw-900 mr-2"
                                            style="transform-origin: 0 50%; transform: rotate(-90deg) translate(-50%, 50%);"></i>
                                        <span>Services</span>
                                    </a>
                                    <div class="mb-1">
                                        <small
                                            class="fs-12 text-secondary">{{ translate('Find & Build your job with') }}</small>
                                    </div>
                                    <a href="{{ route('search') }}?type=freelancer"
                                        class="text-primary fs-14 fw-700 d-flex align-items-center mb-1">
                                        <i class="la la-search fs-20 fw-900 mr-2"
                                            style="transform-origin: 0 50%; transform: rotate(-90deg) translate(-50%, 50%);"></i>
                        ...
                        <div class="col-md-4 d-flex">
                            <div class="card card_shadow card_border w-100 rounded-2 border-gray-light">
                                <div class="card-body mt-3">
                                    <div class="mb-4">
                                        <div class="row">
                                            <div class="col-8">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36"
                                                    ...
                                                    <g id="Group_22127" data-name="Group 22127"
                                                        ...
                                                        <path id="Path_25837" data-name="Path 25837"
                                                            d="M10,5.054V35.022h6.546V5.054Z"
                                                            transform="translate(13.637 4.029)" fill="#e2583e"
                                                            fill-rule="evenodd" />
                                                        <path id="Path_25838" data-name="Path 25838"
                                                            d="M7,8.027V29.039h6.546V8.027Z"
                                                            transform="translate(6.818 10.014)" fill="#f17f53"
                                                            fill-rule="evenodd" />
                                                        <path id="Path_25839" data-name="Path 25839"
                                                            d="M4,11.054V22.942h6.546V11.054Z"
                                                            transform="translate(0 16.109)" fill="#f8b84e"
                                                            fill-rule="evenodd" />
                                                        <path id="Path_25840" data-name="Path 25840"
                                                            d="M13,3.053h6.545v36H13Z" transform="translate(20.455 0)"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36"
                                                    ...
                                                    <g id="Group_22129" data-name="Group 22129"
                                                        ...
                                                        <path id="Path_25837" data-name="Path 25837"
                                                            ...
                                                            fill-rule="evenodd" />
                                                        <path id="Path_25838" data-name="Path 25838"
                                                            d="M7,8.027V29.039h6.545V8.027Z"
                                                            transform="translate(6.818 10.014)" fill="#45b5aa"
                                                            fill-rule="evenodd" />
                                                        <path id="Path_25839" data-name="Path 25839"
                                                            d="M4,11.054V22.942h6.545V11.054Z"
                                                            transform="translate(0 16.108)" fill="#45b5aa"
                                                            fill-rule="evenodd" />
                                                        <path id="Path_25840" data-name="Path 25840"
                                                            d="M13,3.053h6.545v36H13Z" transform="translate(20.455 0)"
                                                            fill="#45b5aa" fill-rule="evenodd" />
                                                    ...
                                                    <g id="Group_22130" data-name="Group 22130"
                                                        ...
                                                        <g id="Group_22128" data-name="Group 22128"
                                                            ...
                                                            <path id="Path_25837" data-name="Path 25837"
                                                                ...
                                                                fill-rule="evenodd" />
                                                            <path id="Path_25838" data-name="Path 25838"
                                                                d="M7,8.027v11.2h6.545V8.027Z"
                                                                transform="translate(2.818 4.77)" fill="#f17f53"
                                                                fill-rule="evenodd" />
                                                            <path id="Path_25839" data-name="Path 25839"
                                                                ...
                                                                fill-rule="evenodd" />
                                                            <path id="Path_25840" data-name="Path 25840"
                                                                d="M13,3.053h6.545v24H13Z"
                                                                transform="translate(16.455 -3.053)" fill="#f8b84e"
                                                                fill-rule="evenodd" />
                                                        </g>
                        ...
                        <div class="col-md-4 d-flex">
                            <div class="card card_shadow card_border w-100 px-4 rounded-2 border-gray-light">
                                <div class="card-body ">
                                                        ...
                                                        <a href="{{ route('project.details', $project->slug) }}"
                                                            ...
                                                            <span
                                                                ...
                                                                @if ($project->client->photo != null)
                                                                    <img
                                                                        src="{{ custom_asset($project->client->photo) }}">
                                                                @else
                                                                    <img
                        ...
                        <div class="col-md-6">
                            <div class="card card_shadow card_border rounded-2 border-gray-light">
                                <div class="card-header border-0">
                                    ...
                                    <a id="refreshButton" class="btn--lp ml-auto">
                                ...
                                <div class="card-body px-0 pt-0">
                                    <div class="aiz-auto-scroll c-scrollbar-light px-4"
                                        style="height: 340px; overflow-y: scroll;">
                                        <ul id="freelancersList" class="list-group list-group-flush">
        ...
        $(document).on('click', '#refreshButton', function() {
            if ("geolocation" in navigator) {
                navigator.geolocation.getCurrentPosition(function(position) {
                    ...
                    // Call the function to update the freelancers list
                    updateFreelancersList(latitude, longitude);
                });
            } else {
