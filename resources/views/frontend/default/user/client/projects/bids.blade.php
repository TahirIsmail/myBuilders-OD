                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                @if ($bid_user->freelancer->profile->specialist != null)
                                                    <p class="opacity-50 mb-2">
                                                        {{ @$bid_user->freelancer->profile->specialistAt->name }}</p>
                                                @endif
                                                <div class="d-flex text-secondary fs-12 mb-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        @if (
                                                            $bid_user->freelancer->address != null &&
                                                                $bid_user->freelancer->address->city != null &&
                                                                $bid_user->freelancer->address->country != null)
                                                            <span>{{ $bid_user->freelancer->address->city }},
                                                                {{ $bid_user->freelancer->address->country }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="modal-body" id="hiring_modal_body">
                    <form class="form-horizontal" action="{{ route('hiring_confirmation_store') }}" method="POST"
                        ...
                        <div class="form-group text-right">
                            <button type="submit"
                                class="btn btn-sm btn-primary transition-3d-hover mr-1 rounded-1">{{ translate('Shortlist Now') }}</button>
                        </div>
                    </form>
                </div>
            </div>
