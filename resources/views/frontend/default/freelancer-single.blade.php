...
<div class="h-250px">
    ...
    <div class="cover-photo-container"
        style="background-image: url('{{ $freelancer->cover_photo != null ? custom_asset($freelancer->cover_photo) : my_asset('assets/frontend/default/img/cover-place.jpg') }}');"
                            ...
                            <div class="mr-3 mb-4 mb-lg-0 text-center text-md-left">
                                <h1 class="h5 mb-1 fw-700">
                                    ...
                                    @if ($freelancer->profile->nationality)
                                        <img src="{{ my_asset('assets/frontend/default/img/flags/' . $freelancer->profile->nationality . '.png') }}"
                                            alt="flag" class="ml-1" style="vertical-align: baseline !important;">
                                    @endif
                                </h1>
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        @if ($freelancer->address != null && $freelancer->address->city != null && $freelancer->address->country != null)
                                            @if ($freelancer->address != null && $freelancer->address->city != null && $freelancer->address->country != null)
                                                <span class="ml-1">{{ $freelancer->address->city }},
                                ...
                                @foreach ($freelancer->userPortfolios as $key => $portfolio)
                                    <div class="col-xxl-3 col-xl-4 col-sm-6">
                                        <a class="card mb-3 shadow-none hov-overlay overflow-hidden">
                                            <img class="card-img-top img-fit" src="{{ custom_asset($portfolio->photo) }}"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card rounded-2 border-gray-light overflow-hidden hov-box">
                                            <a href="{{ route('service.show', $service->slug) }}"><img
                                                    src="{{ custom_asset($service->image) }}" class="card-img-top img-fit"
                                                    alt="service_image" height="212"></a>
                                            <div class="card-body">
                                                <div class="d-flex mb-2">
                                                    <span class="mr-2"><img
                                                            src="{{ custom_asset($service->user->photo) }}"
                                                            alt="{{ $service->user->name }}" height="35"
                                                            width="35" class="rounded-circle"></span>
                                                    <span class="d-flex flex-column justify-content-center">
                                                        <a href="{{ route('freelancer.details', $freelancer->user_name) }}"
                                                            class="text-secondary"><span
                                                                class="font-weight-bold">{{ $freelancer->name }}</span></a>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="media">
                                                <div class="mr-3">
                                                    <span class="avatar avatar-md m-3">
                                                        <img
                                                            src="{{ custom_asset(\App\Models\User::find($review->reviewer_user_id)->photo) }}">
                                                    </span>
                                                </div>
                                                <div class="media-body">
                                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                                        <div>
                                                            @if ($review->project)
                                                                <a href="{{ route('project.details', $review->project->slug) }}"
                                                                    class="text-reset hov-text-primary fw-600 fs-14 mb-1 lh-1-6">{{ $review->project->name }}</a>
                                                            @else
                ...
                <div class="col-xxl-3 col-lg-4">
                    <div class="card rounded-2 border-gray-light">
                        <div class="card-body">
                            ...
                            <div class="mb-5">
                                <h6 class="text-left mb-4 h6 fw-700"><span
                                        class="bg-white pr-3">{{ translate('Skills') }}</span></h6>
                                <div>
                            ...
                            <div class="mb-3">
                                <h6 class="text-left mb-4 h6 fw-700"><span
                                        class="bg-white pr-3">{{ translate('Share Profile') }}</span></h6>
...
<style>
    .cover-photo-container {
        ...
        /* Added property to prevent image repetition */
        overflow: hidden;
...
<script src="https://unpkg.com/interactjs@1.10.14/dist/interact.min.js"></script>
<script>
    interact('#cover-photo-container')
        .draggable({
            listeners: {
                start(event) {
                ...
                move(event) {
                    ...
                    target.style.backgroundPosition = `0px ${y}px`;
